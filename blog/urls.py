...
urlpatterns = [
    ...
    # ----------------
    #     The following re_path re_path messed with the setup of the ELSA archive directory, found in ELSA 
    #     project directory and online at https://atmos.nmsu.edu/elsa/archive/; hence, the issue.  
    #
    #     However, I left this re_path commented out because I learned about how to nest an argument in
    #     a re_path.
    #
    # re_path(r'^archive/(?:detail-(?P<pk>\d+)/)?$', views.detail, name='detail'),
